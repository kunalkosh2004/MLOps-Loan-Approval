...
DATA_TRANSFORMATION_INPUT_FEATURE_FINAL_PATH:str = 'input.npy'
DATA_TRANSFORMATION_TARGET_FEATURE_FINAL_PATH:str = 'target.npy'
...
MODEL_TRAINER_TRAIN_TEST_SPLIT_RATIO:float = 0.2
